...
class TradingModel(Model):
    ...
    def standard_dev(self):
        ...
        t_range = random.randint(10, 100)  # Considering the last 600-6000 timesteps corresponds to looking at the last
...
interpolate = price_path(simple_model.order_limits)
log_return = log_ret(interpolate)
y_val = [samples[0] for samples in log_return]
print(len(y_val))
result = stats.jarque_bera(y_val)
print(result)
