...
class TradingModel(Model):
    ...
    def __init__(self, l_o_b, time):
        ...
        self.schedule = RandomActivation(self) #subclass from mesa with the function "add" and the list of agents schedule.agents
...
class TradingAgent(Agent):
    ...
    def sell_order(self):
        ...
        if s_order > bid_price:
            ...
            print("Seller", self.unique_id, "meets Buyer", buyer.unique_id, "and sells",N_trade,"shares at",bid_price,"each.")
            print("Agent",self.unique_id," now has",self.cash," amount of cash and ",self.shares,"amount of shares.")
            print("Agent",buyer.unique_id,"now has",buyer.cash,"amount of cash and",buyer.shares,"amount of shares.")
            print(self.model.limit_order_book)
            print()
    ...
    def buy_order(self):
        ...
        if b_order < ask_price:
            ...
            self.shares=self.shares+N_trade
            print("Trade at time",self.model.clock,":")
            print("Buyer", self.unique_id, "meets Seller", seller.unique_id,"and buys",N_trade,"shares at",ask_price,"each.")
            print("Agent",self.unique_id,"now has",self.cash,"amount of cash and",self.shares,"amount of shares.")
            print("Agent",seller.unique_id,"now has",seller.cash,"amount of cash and",seller.shares,"amount of shares.")
            print(self.model.limit_order_book)
            print()
